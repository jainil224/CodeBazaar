            ...
            <ReceiptPrinter.Output className="w-full max-w-[395px]">
              <ReceiptPrinter.Paper>
                ...
                <div ref={receiptRef} className="printable-receipt text-left select-text bg-gradient-to-b from-[#ffffff] via-[#faf9ff] to-[#f4f2fd] p-3 text-[#131127] rounded-sm relative">
                  ...
                  <div className="text-center pb-2.5 border-b border-dashed border-purple-200 flex flex-col items-center">
                    {/* Centered Favicon Logo */}
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-primary-indigo/15 via-primary-pink/15 to-primary-orange/15 p-1 flex items-center justify-center border border-purple-200/80 shadow-xs mb-1.5">
                      <img src={faviconLogo} alt="CodeBazaar Favicon" className="w-full h-full object-contain drop-shadow-xs" />
                    </div>
                    
                    <h2 className="text-xs font-black uppercase tracking-[0.18em] text-slate-900 font-mono">
                      CodeBazaar Receipt
                    </h2>
                  ...
                  <div className="py-2.5 border-b border-dashed border-purple-200">
                    <div className="flex gap-2.5 items-center">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5">
                          <span className="text-[8.5px] uppercase tracking-wider font-extrabold px-1.5 py-0.5 rounded bg-purple-100/70 text-purple-800 font-mono">
                  ...
                  {/* Clean Transaction Key-Value List */}
                  <div className="py-2.5 border-b border-dashed border-purple-200 space-y-1.5 text-[11px] font-mono">
                    ...
                    <div className="flex justify-between items-center text-slate-600">
                      ...
                      <div className="flex items-center gap-1 font-semibold text-slate-900">
                        <span className="truncate max-w-[140px]">{receiptData.paymentId}</span>
                        <button
                  ...
                  {/* Clean Total Row */}
                  <div className="py-2.5 border-b border-dashed border-purple-200 flex justify-between items-baseline font-mono">
                    <span className="text-xs font-black text-slate-900 uppercase tracking-tight">TOTAL PAID:</span>
                    <span className="text-base font-black bg-gradient-to-r from-primary-indigo via-purple-600 to-pink-600 bg-clip-text text-transparent">
                      ₹{receiptData.amount}
                    </span>
                  </div>
                  ...
                  <div className="pt-2.5 pb-1 flex flex-col items-center text-center">
                    <svg className="w-44 h-8" viewBox="0 0 192 36" fill="currentColor">
