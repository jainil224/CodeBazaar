...
const PROJECTS: Project[] = [
  {
    ...
    detail: {
      ...
      techStack: [
        { category: 'Frontend', items: ['React 19', 'TypeScript', 'Tailwind CSS v4', 'Framer Motion'] },
        { category: 'Backend / BaaS', items: ['Firebase Auth', 'Firestore', 'Firebase Security Rules'] },
        { category: 'Payments', items: ['Razorpay Checkout SDK', 'Live & Test Keys'] },
        { category: 'Build Tools', items: ['Vite 8', 'oxlint', 'PostCSS'] },
      ],
      features: [
      ...
      highlights: [
        { icon: <Layers className="w-5 h-5" />, label: 'Components', value: '15+' },
        { icon: <Zap className="w-5 h-5" />, label: 'Build Time', value: '< 1s' },
        { icon: <Shield className="w-5 h-5" />, label: 'Auth', value: 'Firebase' },
        { icon: <Smartphone className="w-5 h-5" />, label: 'Responsive', value: '100%' },
      ],
    },
  },
  {
    ...
    detail: {
      ...
      techStack: [
        ...
        { category: 'Database', items: ['Prisma ORM', 'PostgreSQL'] },
      ],
      features: [
      ...
      highlights: [
        { icon: <Layers className="w-5 h-5" />, label: 'Pages', value: '10+' },
        { icon: <Zap className="w-5 h-5" />, label: 'Framework', value: 'Next.js' },
        { icon: <Shield className="w-5 h-5" />, label: 'Payments', value: 'Stripe' },
        { icon: <Smartphone className="w-5 h-5" />, label: 'Responsive', value: '100%' },
      ],
    },
  },
  {
    ...
    detail: {
      ...
      tags: ['React', 'OpenAI', 'Framer Motion', 'Tailwind'],
      techStack: [
        { category: 'Frontend', items: ['React', 'TypeScript', 'Framer Motion', 'Tailwind CSS'] },
        { category: 'AI', items: ['OpenAI API', 'Stream Parsing', 'Vector Memory'] },
        { category: 'Rendering', items: ['React Markdown', 'Prism.js'] },
      ],
      features: [
      ...
      highlights: [
        { icon: <Zap className="w-5 h-5" />, label: 'Streaming', value: 'Yes' },
        { icon: <Layers className="w-5 h-5" />, label: 'AI Model', value: 'OpenAI' },
        { icon: <Shield className="w-5 h-5" />, label: 'Memory', value: 'Vector' },
        { icon: <Smartphone className="w-5 h-5" />, label: 'Responsive', value: '100%' },
      ],
    },
  },
  {
    ...
    detail: {
      ...
      tags: ['React', 'Context API', 'Lucide Icons', 'Vite'],
      techStack: [
        { category: 'Frontend', items: ['React', 'TypeScript', 'Context API', 'Vite'] },
        { category: 'State', items: ['React Context', 'localStorage persistence'] },
        { category: 'UI', items: ['Lucide Icons', 'CSS Modules', 'Vanilla CSS'] },
      ],
      features: [
      ...
      highlights: [
        { icon: <Zap className="w-5 h-5" />, label: 'Framework', value: 'Vite' },
        { icon: <Layers className="w-5 h-5" />, label: 'Products', value: '50+' },
        { icon: <Shield className="w-5 h-5" />, label: 'Backend', value: 'None' },
        { icon: <Smartphone className="w-5 h-5" />, label: 'Responsive', value: '100%' },
      ],
    },
  },
  {
    ...
    detail: {
      ...
      tags: ['HTML5', 'GSAP', 'Vite', 'CSS Gradients'],
      techStack: [
        { category: 'Core', items: ['HTML5', 'CSS3', 'Vanilla JS'] },
        { category: 'Animation', items: ['GSAP 3', 'ScrollTrigger', 'Magnetic Effects'] },
      ...
      highlights: [
        { icon: <Zap className="w-5 h-5" />, label: 'Animation', value: 'GSAP 3' },
        { icon: <Layers className="w-5 h-5" />, label: 'Sections', value: '6' },
        { icon: <Shield className="w-5 h-5" />, label: 'Deps', value: 'Zero' },
        { icon: <Smartphone className="w-5 h-5" />, label: 'Responsive', value: '100%' },
      ],
    },
  },
