import { Terminal, Code2, Download, Loader2 } from 'lucide-react';
          ...
          return (
            ...
            >
              ...
              <div className="p-8 flex-1 flex flex-col">
                <h4 className="text-xl font-bold text-white group-hover:text-primary-pink transition-colors">
                  {project.title}
                </h4>
                ...
                <div className="mt-8 border-t border-white/15 pt-6">
                  {isPurchased ? (
                    ...
                    <button
                      ...
                      className="uiverse-btn font-sans overflow-hidden"
                    >
                      {isLoading ? (
                        <>
