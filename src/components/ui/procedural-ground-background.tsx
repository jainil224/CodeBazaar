  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        // Color Palette - Modified for CodeBazaar Theme
        vec3 baseColor = vec3(0.02, 0.01, 0.08); // Very Dark Purple
        vec3 accentColor = vec3(0.4, 0.1, 0.6);   // Deep Violet/Purple
        vec3 neonColor = vec3(0.8, 0.2, 1.0);     // Neon Fuchsia/Purple
