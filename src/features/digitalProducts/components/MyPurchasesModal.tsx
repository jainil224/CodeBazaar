...
import { X, Calendar, Package, ExternalLink, ShieldAlert } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/75 backdrop-blur-md text-slate-800">
      <div className="relative w-full max-w-[800px] bg-zinc-950 border-[2px] border-white/10 rounded-[36px] p-8 shadow-[0_0_32px_rgba(0,0,0,0.5)] backdrop-blur-[32px] overflow-hidden max-h-[85vh] flex flex-col text-white">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-white/60">Access files and resources for your licensed items</p>
        </div>
                  ...
                  <div className="w-full sm:w-[220px] flex flex-col gap-2 shrink-0">
                    ...
                    {product && (
                      <button
                        ...
                        className="w-full py-2 border border-white/10 hover:border-white/20 bg-white/5 hover:bg-white/10 text-white rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                      >
